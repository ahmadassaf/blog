...
This guide will show you how to dynamically generate OG images for your blog using [Next.js](https://nextjs.org/), enabling each post to have a unique, shareable image that stands out.
...
This inline code `console.log("Hello World"){:js}` will be highlighted.
...
I have a [contentlayer](https://contentlayer.dev/) setup in my project, which allows me to fetch all the blog posts from my `content` directory. I will use this data to generate the OG images dynamically.
