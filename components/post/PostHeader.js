...
const PostHeader = ({ frontMatter, siteMetadata, toc }) => (
  <div className={ `pt-6 max-xl:w-[100%] ${(toc.length > 3 && !frontMatter.hideToC) ? 'w-[60%]' : 'w-[100%]'}` }>
    ...
    <div className='space-y-1 text-left'>
      ...
      <h3 className='text-1xl sm:text-xl tracking-tight text-gray-600 dark:text-gray-100 sm:leading-10 md:text-2xl capitalize pb-4'>
        {frontMatter.subtitle}
      </h3>

    </div>
    <h4 className='text-gray-500 sm:text-md'>{frontMatter.readingTime.text}</h4>
