          ...
          <dd className='mt-1 flex items-baseline justify-between md:block lg:flex'>
            ...
            >
              {item.changeType === 'increase' ? (
                <ArrowUpIcon className='-ml-1 mr-0.5 h-5 w-5 shrink-0 self-center text-green-500' aria-hidden='true'/>
              ) : (
                <ArrowDownIcon className='-ml-1 mr-0.5 h-5 w-5 shrink-0 self-center text-red-500' aria-hidden='true'/>
              )}
