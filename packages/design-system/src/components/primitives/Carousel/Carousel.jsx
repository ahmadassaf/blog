...
const AppleCard = ({ classNames, isActive, item, onOpen, radius, size }) => (
  <article className={ carouselCardVariants({ 'className': cn(isActive && 'ring-2 ring-blue-500 ring-offset-2 dark:ring-offset-gray-950', classNames.card), radius, size }) }>
    <CarouselImage image={ item.image } alt={ item.alt || item.title } className={ classNames.image } />
    <div className='absolute inset-0 bg-linear-to-t from-gray-950 via-gray-950/60 to-gray-950/15' aria-hidden='true' />
    <button
