...
export default function LayoutContainer({ children }) {
  ...
  return (
    <div className='bg-white text-black antialiased dark:bg-black dark:text-white min-w-[414px]'>
      <Aurora>
        <div className='hidden dark:absolute min-h-[50rem] w-full dark:bg-black dark:bg-dot-white/[0.25] dark:flex items-center justify-center'>
