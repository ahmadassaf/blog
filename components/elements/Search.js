...
const Search = ({ setSearchValue }) => (
  <div className='relative mt-8 border-none'>
    <input
      ...
      className='block w-full border-0 bg-transparent px-0 py-2 text-gray-900 focus:border-b-2 focus:border-blue-500 focus:outline-none focus:ring-0 dark:bg-transparent dark:text-gray-100 dark:focus:border-blue-400'
    />
