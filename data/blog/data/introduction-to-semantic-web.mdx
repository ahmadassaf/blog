...
tags: ['Semantic Web', 'Linked Data', 'Knowledge Representation', 'Structured Data', 'Knowledge Graphs']
...
- **[Web 3.0](http://www.w3.org/standards/semanticweb)** is all about connecting the data .. <Highlight>not the documents but the data at lower levels</Highlight> and facilitate machine to machine communication
...
<Callout type='info'>What "semantic" means in the Semantic Web is not that computers will understand the meaning of anything but that the logical pieces of meaning can be mechanically manipulated by a machine to valuable ends. </Callout>
