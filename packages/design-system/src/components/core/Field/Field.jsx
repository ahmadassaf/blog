...
export const FieldInput = ({ className, ...props }) => (
  <input className={ cn('min-h-10 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-950 shadow-xs placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100', className) } { ...props } />
);
