      ...
      <div className='-mt-px flex w-0 flex-1 group'>
        ...
        {prevPage && (
          <a
            ...
            className='inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 group-hover:border-blue-700 group-hover:text-blue-700'
          >
      ...
      <div className='-mt-px flex w-0 flex-1 justify-end group'>
        ...
        {nextPage && (
          <a
            ...
            className='inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 group-hover:border-blue-700 group-hover:text-blue-700'
          >
        Next
