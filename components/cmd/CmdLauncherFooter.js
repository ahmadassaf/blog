const CmdLauncherFooter = () => (
  <div className='text-sm p-2 flex flex-row'>
    <span className='flex items-center mx-2 max-sm:hidden!'>
      <svg version='1.0' className='bg-gray-200 px-1 py-1 w-4 h-4 rounded-sm mx-1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1280 1280'>
    ...
    <span className='flex items-center mx-2'>
      <svg xmlns='http://www.w3.org/2000/svg' className='bg-gray-200 px-1 py-1 w-4 h-4 rounded-sm mx-1' viewBox='0 0 24 24'>
        <path d='M0 0h24v24H0V0z' fill='none' />
        <path d='M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z'/>
      </svg>
      <svg
        xmlns='http://www.w3.org/2000/svg' className='bg-gray-200 px-1 py-1 w-4 h-4 rounded-sm mx-1' viewBox='0 0 24 24'>
        <path d='M0 0h24v24H0V0z' fill='none' />
    ...
    <span className='flex items-center mx-2'>
      <span className='bg-gray-200 px-1 py-1 rounded-sm mx-1 text-xs dark:text-gray-800'>esc</span>to close / go back
    </span>
  </div>
);
