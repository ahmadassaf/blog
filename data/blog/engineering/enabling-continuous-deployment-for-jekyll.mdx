...
tags: ['Jekyll', 'Continuous Integration', 'Continuous Deployment', 'Static Site Generation', 'Automation']
...
<Image className='mx-auto' width={600} height={600} src="/static/images/posts/jekyll-ci.svg" darkSrc="/static/images/posts/jekyll-ci-dark.svg" alt="jekyll-ci" />
