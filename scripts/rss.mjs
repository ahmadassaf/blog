...
const _generateRssItem = (post) => `
  <item>
    ...
    <author>${_escapeXml(authorMetadata.email)} (${_escapeXml(authorMetadata.author)})</author>
...
const _generateRss = (posts, page = 'feed.xml') => `
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      ...
      <managingEditor>${_escapeXml(authorMetadata.email)} (${_escapeXml(authorMetadata.author)})</managingEditor>
      <webMaster>${_escapeXml(authorMetadata.email)} (${_escapeXml(authorMetadata.author)})</webMaster>
