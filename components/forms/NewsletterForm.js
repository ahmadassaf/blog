    ...
    <div className='mt-8 xl:col-span-2 xl:mt-0'>
      ...
      <form className='mt-4 sm:flex sm:max-w-md' onSubmit={ subscribe }>
        ...
        <input
          ...
          type='email'
          disabled={ subscribed }
          className='rounded-sm w-full min-w-0 appearance-none md:text-sm border border-gray-300 bg-white py-2 px-4 text-base text-gray-900 placeholder-gray-500 shadow-xs focus:border-indigo-500 focus:placeholder-gray-400 focus:outline-hidden focus:ring-indigo-500'
        />
